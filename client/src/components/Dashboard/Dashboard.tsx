        ...
        return (
            <div className="">
                ...
                <Modal isOpen={this.state.invoicesModal} toggle={this.toggleInvoicesModal} size="lg">
                    ...
                    <ModalBody>
                        <hr/>
                        <div className="item-wrapper" style={{fontWeight: 'bold'}}>
                            <div className="item-no">#</div>
                            <div className="item-number">Number</div>
                            <div className="item-from">From</div>
                        ...
                        <hr/>
                        {
                            localInvoices.map((item, index)=>{
                                return(
                                    <div key={index} >
                                        <div className="invoice-list item-wrapper" onClick={()=>this.selectInvoice(item.invoice)} >
                                            <div className="item-no">{index+1}</div>
                                            <div className="item-number">{item.invoice.number}</div>
                                            <div className="item-from">{item.invoice.from}</div>
                                            <div className="item-to">{item.invoice.to}</div>
                ...
                <Navbar color="dark" dark >
                    <NavbarBrand href="/">Basemath Invoice Generator</NavbarBrand>
                        ...
                        <div className="top_w">
                            <div className="left_w">
                                ...
                                <FormGroup>
                                    <EditableLabel 
                                        ...
                                        labelClassName='inline_label width-200'
                                        inputClassName='inline_input width-200'
                            ...
                            <div className="right_w">
                                <EditableLabel 
                                    ...
                                    labelClassName='inline_label width-400 right-text title'
                                    inputClassName='inline_input width-400 right-text title'
                                ...
                                <div className="right_align_input_group">
                                    <EditableLabel 
                                        ...
                                        labelClassName='inline_label width-200 right-text'
                                        inputClassName='inline_input width-200 right-text'
                                ...
                                <div className="balance-due-w">
                                    <EditableLabel 
                                        text={this.state.invoice.balance_title}
                                        labelClassName='inline_label width-200 right-text balance-due'
                                        inputClassName='inline_input width-200 right-text balance-due'
                            ...
                            <div className="table_header">
                                <div style={{width: 550}}>
                                    <EditableLabel
                                        ...
                                        labelClassName='inline-label-header width-200'
                                        inputClassName='inline-input-header width-200'
                                ...
                                <div style={{width: 100}}>
                                    <EditableLabel
                                        ...
                                        labelClassName='inline-label-header width-100'
                                        inputClassName='inline-input-header width-100'
